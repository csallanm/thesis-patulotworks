        ...
        <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
            <div class="shadow-lg p-3 mb-4 rounded position-absolute" id="login_shape1">
                ...
                <form class="form-inline my-2 my-lg-0" action="userotp.php" method="POST" autocomplete="">
                    <input class="form-control w-75" name="otp" id="otp" type="number" placeholder="Verification code" required>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input class="form-control button btn btn-secondary" type="submit" name="check" value="Get code">
                        </div>
                    </div>
            </div>
            </form>
